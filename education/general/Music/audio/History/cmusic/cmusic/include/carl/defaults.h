...
#else
#define CDPREFIX	"./"	/* cdsf pathnames dir */
#define SFSTAB		"./"	/* system configuration table */
#define SFERRLOG	"./sferrlog"	/* error log */
#define COREDIR		"./"	/* core dir, used by panic() */
#define CLOSESF		bindir(closesf
#endif

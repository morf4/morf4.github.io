/* crack.c	1.1	(CARL)	7/25/84	13:41:57 */
/*
 ...
 * argument after the last flag, which should be the first file, if
 * any.  If there are no arguments, or no more arguments after reading 
 * the flags, arg_index == argc;
 * 
 * Flags may be concatenated, for instance: -cd will treat c and d as

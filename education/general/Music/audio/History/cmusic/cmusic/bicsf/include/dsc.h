...
# define DSCFLT2	    0.0		/* bypass mode */
# define DSCFLT3	    0.0		/* not installed */
# define DSHASDAF0	1		/* has flt12800 */
# define DSHASDAF1	1		/* has flt6400 */
# define DSHASDAF2	1		/* has bypass */
# define DSHASDAF3	0		/* not installed */
# define DSHASADF0	1		/* has flt12800 */
# define DSHASADF1	1		/* has flt6400 */
# define DSHASADF2	1		/* has bypass */
# define DSHASADF3	0		/* not installed */
# endif IRCAM
...
# ifdef SYNC
# define EDS_TIMEOUT	0200	/* dstimeout (sync) clobbered us */
# endif
...
# ifdef SYNC
# define DSSYNC		_IO(s, 19)			/* Tape sync */
